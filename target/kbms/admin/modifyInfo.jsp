...
<div id="p" class="easyui-panel" title="修改个人信息" style="padding: 10px">
	<form id="form1" action="${kbms}/admin/user/save.do" method="post" enctype="multipart/form-data">
 ...
 <script type="text/javascript">
    ...
    ue.addListener("ready",function(){
        //通过ajax请求数据
        UE.ajax.request("${pageContext.request.contextPath}/admin/user/find.do",
            {
                method:"post",
                async : false,  
                data:{},
